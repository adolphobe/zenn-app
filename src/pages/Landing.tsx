...
const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <style>
        {`
          /* ... (suas animações CSS existentes, sem alterações aqui) ... */
          ...
          .gradient-card-hover { position: relative; overflow: hidden; z-index: 1; transition: transform 0.3s ease, box-shadow 0.3s ease; }
          ...
          .gradient-card-hover:hover { transform: translateY(-5px); box-shadow: 0 15px 30px rgba(124, 179, 248, 0.15); }
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden">
          {/* CORREÇÃO: Adicionado isolamento, transform e overflow ao parallax-container */}
          <div 
            className="parallax-container w-full h-full"
            style={{ isolation: 'isolate', transform: 'translateZ(0)', overflow: 'hidden' }}
          >
            <img 
              ...
              id="parallax-bg"
            />
            {/* CORREÇÃO: Adicionado isolamento, transform e will-change ao div do backdrop-blur */}
            <div 
              className="absolute inset-0 bg-[#f9fbff]/50 backdrop-blur-[6px]"
              style={{ 
                isolation: 'isolate', 
                transform: 'translateZ(0px)', // ou scale(1)
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            {showLogin ? (
              <div className="w-full h-full flex items-center justify-center">
                <div className={`w-full max-w-md bg-white/80 backdrop-blur-md p-8 rounded-xl shadow-xl ${showLogin ? 'slide-in' : ''}`}>
              ...
              <div className={`relative w-full h-[600px] transition-all duration-1000 ease-in-out ${loaded ? 'opacity-100' : 'opacity-0'}`}>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-[350px] h-[350px] rounded-full backdrop-blur-sm animate-pulse-enhanced" style={{ backgroundColor: 'rgb(159 215 255)', boxShadow: 'rgba(129, 177, 255, 0.3) 0px 0px 25px' }}></div>
                  <div className="absolute w-[300px] h-[300px] rounded-full backdrop-blur-md animate-floating-enhanced" style={{ animationDuration: '10s', backgroundColor: 'rgb(164 211 245)', boxShadow: 'rgba(255, 255, 255, 0.28) 0px 0px 20px' }}></div>
                  <div className="absolute w-[250px] h-[250px] rounded-full backdrop-blur-md animate-floating-enhanced" style={{ animationDuration: '8s', animationDelay: '1s', backgroundColor: 'rgb(159 209 243)', boxShadow: 'rgba(255, 255, 255, 0.25) 0px 0px 20px' }}></div>
                </div>
              </div>
            )}
          </div>
     ...
     {/* CORREÇÃO: Adicionado isolation: 'isolate' à Features Section */}
     <section 
        className="py-32 relative z-10 overflow-hidden bg-gradient-to-b from-white via-blue-100 to-white" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <Card className="gradient-card-hover bg-white/90 backdrop-blur-sm border-none shadow-lg h-full rounded-xl overflow-hidden transition-all duration-300">
                <CardContent className="p-10 flex flex-col h-full">
                  <div className="rounded-full bg-blue-50 w-16 h-16 flex items-center justify-center mb-8 transition-transform duration-300 group-hover:scale-110">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 12L11 14L15 10M12 3L4.5 10.5L4.5 20.5H19.5V10.5L12 3Z" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
              ...
              <Card className="gradient-card-hover bg-white/90 backdrop-blur-sm border-none shadow-lg h-full rounded-xl overflow-hidden transition-all duration-300">
                <CardContent className="p-10 flex flex-col h-full">
                  <div className="rounded-full bg-blue-50 w-16 h-16 flex items-center justify-center mb-8">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 16.5V14M7 10.5H17M7 7.5H17M9 19.5H15C16.1046 19.5 17 18.6046 17 17.5V6.5C17 5.39543 16.1046 4.5 15 4.5H9C7.89543 4.5 7 5.39543 7 6.5V17.5C7 18.6046 7.89543 19.5 9 19.5Z" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
            ...
            <div className="animate-on-scroll" style={{ transitionDelay: '0.5s' }}>
              <Card className="gradient-card-hover bg-white/90 backdrop-blur-sm border-none shadow-lg h-full rounded-xl overflow-hidden transition-all duration-300">
                <CardContent className="p-10 flex flex-col h-full">
                  <div className="rounded-full bg-blue-50 w-16 h-16 flex items-center justify-center mb-8">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 17L15 17M12 13L12 7M12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21Z" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
    ...
    <section className="relative z-10 overflow-hidden bg-gradient-to-b from-white via-blue-100 to-white">
        <div className="container mx-auto px-8 relative z-10">
            ...
            <div className="relative">
              ...
              <div className="space-y-20">
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start animate-on-scroll">
                  <div className="flex-shrink-0 relative"><div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-400 shadow-lg flex items-center justify-center text-white text-4xl font-bold">1</div><div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full bg-blue-100 opacity-70"></div></div>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start animate-on-scroll">
                  <div className="flex-shrink-0 relative"><div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-500 shadow-lg flex items-center justify-center text-white text-4xl font-bold">2</div><div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full bg-blue-100 opacity-70"></div></div>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start animate-on-scroll">
                  <div className="flex-shrink-0 relative"><div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-700 to-blue-600 shadow-lg flex items-center justify-center text-white text-4xl font-bold">3</div><div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full bg-blue-100 opacity-70"></div></div>
          ...
          <div className="mt-32 animate-on-scroll">
            <div className="relative mx-auto max-w-4xl">
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl border border-white/30"><img src="https://images.unsplash.com/photo-1555421689-3f034debb7a6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="Dashboard" className="w-full h-auto"/><div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 via-blue-400/10 to-transparent"></div></div>
              <div className="absolute top-10 right-10 max-w-xs bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg border border-blue-100"><h4 className="font-medium text-blue-700 mb-1">Visão por Pilares</h4><p className="text-sm text-gray-600">Visualize rapidamente suas tarefas organizadas de acordo com os três pilares fundamentais.</p></div>
              <div className="absolute bottom-10 left-10 max-w-xs bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg border border-blue-100"><h4 className="font-medium text-blue-700 mb-1">Score Intuitivo</h4><p className="text-sm text-gray-600">Identifique facilmente quais tarefas merecem sua atenção prioritária através dos scores visuais.</p></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative">
                    ...
                    <Card className="bg-white border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden rounded-2xl h-full">
                      <CardContent className="p-8">
                        ...
                        <div className="flex items-center">
                          ...
                          <div><h4 className="font-semibold text-gray-900">{testimonial.name}</h4><p className="text-gray-500 text-sm">{testimonial.role}</p></div>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
              ...
              <div className="flex justify-center mt-10 gap-3">
                {[0, 1, 2].map((index) => (<button key={index} onClick={() => setActiveTestimonial(index)} className={`w-3 h-3 rounded-full transition-all duration-300 ${activeTestimonial === index ? 'bg-blue-600 w-10' : 'bg-blue-200'}`}/>))}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 relative z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -left-40 w-80 h-80 bg-white/10 rounded-full blur-xl"></div><div className="absolute top-20 right-20 w-60 h-60 bg-white/10 rounded-full blur-xl"></div><div className="absolute bottom-20 left-1/3 w-40 h-40 bg-white/10 rounded-full blur-xl"></div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="animate-on-scroll">
              ...
              <div className="relative inline-block group">
                ...
                <Button onClick={handleGetStarted} className="relative bg-white text-blue-600 hover:text-blue-700 hover:bg-blue-50 px-10 py-6 rounded-xl text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center gap-3 mx-auto">Começar com Clareza <ArrowRight className="transition-transform duration-300 group-hover:translate-x-1" /></Button>
              </div>
...
<footer className="py-16 bg-gray-900 text-gray-400 relative z-10">
  <div className="container mx-auto px-8">
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-gray-500 mb-8 max-w-lg">Zenn é um app de execução pessoal que te ajuda a focar no que realmente importa, avaliando cada tarefa por três pilares: importância real, orgulho pós-execução e crescimento pessoal.</p>
      <div className="flex gap-6 mb-12">
        <a href="#" className="text-gray-500 hover:text-blue-400 transition-colors"><svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg></a>
        <a href="#" className="text-gray-500 hover:text-blue-400 transition-colors"><svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z" /></svg></a>
        <a href="#" className="text-gray-500 hover:text-blue-400 transition-colors"><svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg></a>
      </div>
      <div className="border-t border-gray-800 pt-8 w-full text-center"><p className="text-sm text-gray-600">© 2023 Zenn. Todos os direitos reservados.</p></div>
    </div>
  </div>
</footer>
    </div>

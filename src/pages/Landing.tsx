...
const Landing: React.FC = () => {
  ...
  const floatingElements = Array(6).fill(null).map((_, i) => (
    <div 
      ...
      style={{
        backgroundColor: i % 2 === 0 ? 'rgba(150, 202, 255, 0.4)' : 'rgba(229, 233, 255, 0.4)',
      ...
      <div className="container mx-auto min-h-screen grid grid-cols-1 lg:grid-cols-12 relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center px-8 md:px-16 lg:px-20 py-16 lg:py-0">
          ...
          <div className={`mb-12 opacity-0 ${loaded ? 'opacity-100 transition-opacity duration-700' : ''}`}>
            <h3 className="text-2xl font-bold tracking-tight text-blue-600">Zenn</h3>
          </div>
        ...
        <div className="lg:col-span-5 relative hidden lg:flex items-center justify-center">
          <div className={`relative w-full h-[600px] opacity-0 ${loaded ? 'opacity-100 transition-all duration-1000 ease-in-out' : ''}`}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[350px] h-[350px] rounded-full bg-gradient-to-tr from-blue-400/20 to-purple-300/20 backdrop-blur-sm animate-pulse-slow"></div>
              <div className="absolute w-[300px] h-[300px] rounded-full bg-gradient-to-bl from-blue-500/20 to-indigo-300/20 backdrop-blur-md animate-float" style={{ animationDuration: '20s' }}></div>
              <div className="absolute w-[250px] h-[250px] rounded-full bg-gradient-to-r from-indigo-300/20 to-blue-400/20 backdrop-blur-md animate-float" style={{ animationDuration: '15s', animationDelay: '2s' }}></div>
            </div>
            ...
            <div 
              ...
              style={{
                background: 'radial-gradient(circle, rgba(214,235,255,0.4) 0%, rgba(150,202,255,0.1) 50%, rgba(229,233,255,0) 100%)',
                boxShadow: '0 0 80px rgba(150, 202, 255, 0.2)',

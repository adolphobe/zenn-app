                  ...
                  <FormItem className="transition-all duration-300 ease-in-out hover:translate-x-1">
                    <div className="relative">
                      ...
                      <FormControl>
                        <Input
                          placeholder="E-mail"
                          className="pl-10 h-12 bg-white/80 backdrop-blur-sm border-gray-200 shadow-sm transition-all duration-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-transparent focus:shadow-none"
                          {...field}
                        />
                      </FormControl>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <FormControl>
                        <Input
                          ...
                          placeholder="Senha"
                          className="pl-10 pr-10 h-12 bg-white/80 backdrop-blur-sm border-gray-200 shadow-sm transition-all duration-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-transparent focus:shadow-none"
                          {...field}
                        />
                      </FormControl>
                      <button

...
const MainContent: React.FC<MainContentProps> = ({ loaded, isNavigating, onNavigate }) => {
  return (
    <main 
      className={`flex flex-col items-center justify-center text-center px-6 transition-all duration-1000 ease-out ${
        isNavigating 
    ...
    >
      ...
      <Button 
        ...
        className="text-lg px-8 py-6 rounded-full bg-blue-400 hover:bg-blue-500 text-white shadow-lg shadow-blue-200/50 hover:shadow-blue-300/50 transition-all duration-500 transform hover:translate-y-[-2px] hover:scale-[1.03] animate-fade-in"
      >

...
<div className="rounded-md bg-white p-[10px] text-blue-600 border border-blue-200 text-[13px]">
      ...
      <div className="rounded-md bg-white px-3 py-2 text-orange-600 border border-orange-200 text-[13px]">
      ...
      <div className="rounded-md bg-white px-3 py-2 text-green-600 border border-green-200 text-[13px]">

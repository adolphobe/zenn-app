...
<div className="rounded-md bg-white px-[10px] py-[3px] text-orange-600 border border-orange-200 text-[13px] mt-[6px]">
...
<div className="rounded-md bg-white px-[10px] py-[3px] text-green-600 border border-green-200 text-[13px] mt-[6px]">
